...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                //     path: '/refactory/todo',
                //     name: 'Todo',
                //     component: () => import('./views/refactory/todo/Todo.vue'),
                //     meta: {
                //         rule: 'admin'
                //     }
                // },
                {
                    ...
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Personil List', active: true },
                        ],
                        pageTitle: 'Personil List',
                        rule: 'editor'
                    }
                },
                {
                    path: '/refactory/notification/create-notification',
                    name: 'createNotification',
                    component: () => import('./views/refactory/notification/Notification.vue'),
                    meta: {
                        rule: 'admin'
                    }
                },
                {
                    path: '/refactory/notification2',
                    name: 'readNotification',
                    component: () => import('./views/refactory/FileUpload.vue'),
                    meta: {
                        rule: 'admin'
                    }
                },
