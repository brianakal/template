...
let colors = {
	// primary: '#7367F0',
	// ditambahkan local storage agar settingan theme tidak hilang saat di reload
...
const themeConfig = {
	...
	navbarType: localStorage.getItem('navbarTypeLocal') || "sticky",				// options[String]: floating(default) / static / sticky / hidden
	footerType: localStorage.getItem('footerTypeLocal') || "sticky",				// options[String]: static(default) / sticky / hidden
